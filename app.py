...
#     moon_deg = next(pos for planet, pos in data['planets'].items() if planet == 'Moon')
#     sun_deg = next(pos for planet, pos in data['planets'].items() if planet == 'Sun')

# # Convert degrees string back to decimal
...
# # Build left_table with actual Panchang
# left_table = {
